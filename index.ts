...
export function consumeSession(config: Config, token: string): Session {
  ...
  */
  ...
  Ideally, `tokenExpiresIn` should be set to a duration as short as possible, but
  ...
  */
  ...
  /*
  Generate and return a new token only if the request's token is the latest one,
